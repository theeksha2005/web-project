...
import { Link } from 'react-router-dom'; // You can replace with `a` if not using React Router
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-2">
            {[
              ...
              { name: 'Games', href: '/games', icon: Gamepad2, color: 'bg-purple-100 text-purple-600 hover:bg-purple-200' },
              { name: 'Stargazing', href: '/stargazing', icon: Star, color: 'bg-indigo-100 text-indigo-600 hover:bg-indigo-200' },
              { name: 'Shop', href: '/shop', icon: ShoppingBag, color: 'bg-pink-100 text-pink-600 hover:bg-pink-200' },
              { name: 'About', href: '/about', icon: Info, color: 'bg-orange-100 text-orange-600 hover:bg-orange-200' },
